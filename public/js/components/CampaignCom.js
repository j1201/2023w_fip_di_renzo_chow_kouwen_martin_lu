export default {
    ...
    <div class="campaignContain" @click="openCarousalCom">
        <div class="campaBG" :style="'background-image: url(/images/' + block.campBG + ')'">
        </div>
    ...
    <div :id='"carouselExampleIndicators"+block.id' class="carousel collapse slide " data-ride="carousel">
        <ol class="carousel-indicators">
          <li :data-target='"#carouselExampleIndicators"+block.id' data-slide-to="0" class="active"></li>
          <li :data-target='"#carouselExampleIndicators"+block.id' data-slide-to="1"></li>
          <li :data-target='"#carouselExampleIndicators"+block.id' data-slide-to="3"></li>
          <li :data-target='"#carouselExampleIndicators"+block.id' data-slide-to="4"></li>
          <li :data-target='"#carouselExampleIndicators"+block.id' data-slide-to="5"></li>
        </ol>
        ...
        <a class="carousel-control-prev" :href='"#carouselExampleIndicators"+block.id' role="button" data-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" :href='"#carouselExampleIndicators"+block.id' role="button" data-slide="next">
